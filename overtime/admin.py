...
class RequestedAdm(admin.ModelAdmin):
    list_display = ('employee','description', 'overtime_hours', 'overtime_date')
    search_fields = ('overtime_hours', 'employee',)
admin.site.register(RequestedOvertimes, RequestedAdm)